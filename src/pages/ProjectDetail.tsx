          ...
          <div className="container-luxury">
            <AnimatedSection>
              ...
              <h2 className="font-display text-4xl md:text-5xl font-light text-foreground mb-8">
                Relevant <span className="italic text-primary">Documents</span>
              </h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                {project.documents.map((doc, index) => (
                  <a
                    ...
                    className="flex items-center gap-4 p-6 rounded-lg border border-border bg-secondary/50 hover:border-primary/50 hover:bg-primary/5 transition-all group"
                  >
                    ...
                    <div className="flex-1">
                      <h4 className="font-display text-lg text-foreground group-hover:text-primary transition-colors">{doc.title}</h4>
                      <p className="font-body text-xs text-muted-foreground uppercase tracking-wider mt-1 flex items-center gap-1">
