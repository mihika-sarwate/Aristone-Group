        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-16">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="font-body text-lg text-white/60 mb-6">{miraRoadProjectsList.length} Premium Project{miraRoadProjectsList.length !== 1 ? 's' : ''}</p>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="font-body text-lg text-white/60 mb-6">{palgharProjectsList.length > 0 ? `${palgharProjectsList.length} Exclusive Projects` : "To be updated soon"}</p>
              <span className="inline-flex items-center gap-2 font-body text-sm text-primary tracking-wider uppercase">
            ...
            >
              {displayedProjects.length > 0 ? (
                ...
                <div className="text-center py-12">
                  <p className="font-display text-2xl italic text-white/60">To be updated soon</p>
                </div>
              )}
            </motion.div>
          )}
